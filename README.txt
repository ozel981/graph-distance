...
- katalog Doc - zawiera dokumentację projektu,
- katalog Source - zawiera pliki źródłowe.

Korzystanie z programu
1. Po uruchomieniu program pyta o ścieżkę do pliku z macierzami sąsiedztwa. Gdy użytkownik nie poda ścieżki, zostają one wczytane przez standardowe wejście 
   (użytkownik będzie musiał wprowadzić dane przy pomocy klawiatury). Dla każdego grafu należy podać rozmiar macierzy oraz macierz sąsiedztwa.
2. Po wczytaniu macierzy użytkownikowi zostaje przedstawiona lista dostępnych algorytmów obliczania dystansu pomiędzy grafami.
